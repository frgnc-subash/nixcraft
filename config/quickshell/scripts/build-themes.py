...
SEMANTIC_ACCENTS = {
    ...
    "ryo": {"info": "#29c4d9", "warning": "#d99a2b", "success": "#2ecc76"},
...
def rgb(color):
    ...
    retain their glassy surfaces; alpha is deliberately ignored for the contrast
    and blend calculations below. Ryo is hand-authored as opaque AMOLED black
    and isn't generated by this script (it has no waybar.css).
    """
    if color.startswith("#"):
